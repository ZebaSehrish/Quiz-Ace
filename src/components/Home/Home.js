        ...
        <div className='home'>
            <section className='home-items rounded-lg m-14 sm:grid grid-cols-1 md:grid-cols-1 lg:grid-cols-2 '>
                <div className='home-description m-20 pt-32 mr-10 font-medium'>
                    ...
                    <p className='mt-5'>There are various programming languages which include such as HTML(the most basic one), CSS(for styling), PHP, Java, JavaScript etc. to develop the website. Which is the language you’re most comfortable with? Choose the one and learn web development which has a great future in the coming days. Prove yourself with your knowledge!</p>
                </div>
                <div>
